...
$rssFeed = showRSSFeed("https://jogja.antaranews.com/rss/pariwisata-budaya.xml");
?>
...
<head>
  ...
  <link rel="stylesheet" href="/craftjog/css/article.css">
</head>
...
<body>
  ...
  <div id="feedarea" class="container py-5 mt-5 align-items-center">
    <div class="row m-2">
      <h2>Tourism and Culture Article</h2>
    </div>
    <div class="row">
      <?php
      foreach ($rssFeed->channel->item as $item) {
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card mb-4">
            <img src="<?= $image_url = (string) $item->enclosure['url'] ?>" class="card-img-top" alt="Image">
            <div class="card-body">
              <h6 class="card-title">
                <a href="<?= $item->link ?>">
                  <?= $item->title ?>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-rz5DY7aEbfOXwHp9k1QbvOq0Cp3z5cXE2J9jZ7+XQTCtm6az3PaeCae6KrQ5BO+Z" crossorigin="anonymous">
    </script>
  <script>
