...
<head>
  ...
  <title>Product Detail | Craftjog</title>
...
<body>
  ...
  <div class="container mt-5 py-5">
    <div class="row">
      <div class="col-lg-6">
        <img src="<?= $row['CraftImage'] ?>" alt="Product" class="product-image">
      </div>
      <div class="col-lg-6 py-5 mt-5">
        ...
        <div class="product-details mt-3">
          <p><strong>Price:</strong> IDR
            <?= $row['Price'] ?>
          </p>
          <p><strong>Stock:</strong>
            <?= $row['StockAvailable'] ?> pcs
          </p>
        </div>

        <!-- Quantity Input -->
        <div class="quantity-field">
          <button class="value-button decrease-button" onclick="decrease()" title="Decrease">-</button>
          <input type="number" class="number" name="quantity" id="quantity" value="0"
            oninput="validateQuantity(<?= $row['StockAvailable'] ?>)">
          <button class="value-button increase-button" onclick="increase(<?= $row['StockAvailable'] ?>)"
        ...
        <div class="action-buttons mt-4">
          <button class="btn btn-dark">Add to Chart</button>
    ...
    <div class="product-tabs mt-5">
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" id="history-tab" data-bs-toggle="tab" href="#history">Product History</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content p-4">
        ...
        <div class="tab-pane p-4 fade" id="reviews">
    ...
    <div class="other-products mt-5 mb-3">
      <h2>Produk Lainnya</h2>
      <div class="row">

        <?php
        // Query untuk mengambil produk lainnya (limit 4)
        $otherProductsQuery = mysqli_query($conn, "SELECT * FROM crafts WHERE CraftID != $craftID ORDER BY RAND() LIMIT 4");

        // Perulangan untuk menampilkan produk lainnya
        while ($otherProduct = mysqli_fetch_assoc($otherProductsQuery)) {
          ?>
          <div class="col-lg-3 col-md-6 align-items-stretch">
            <div class="card mb-4">
              <img src="<?= $otherProduct['CraftImage'] ?>" alt="" class="card-img-top"
                style="object-fit:cover; height:200px" />
              <div class="card-body">
                <h5 class="card-title text-center">
                  <?= $otherProduct['CraftName'] ?>
                </h5>
                ...
                <div class="text-center fs-6">
                  <a href="/craftjog/view/product-detail.php?id=<?= $otherProduct['CraftID'] ?>" class="btn fs-6">Info
                    Selengkapnya</a>
                </div>
  ...
  <script src="/craftjog/js/product-detail.js"></script>
