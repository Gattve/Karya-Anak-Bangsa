...
<head>
  ...
  <link rel="stylesheet" href="/craftjog/css/cart.css">
</head>
...
<body>
  ...
  <div class="container cart-container py-5">
    ...
    <div class="row product-item">
      <div class="col-lg-6 product-details">
        ...
        <div class="product-price">IDR250000</div>
      </div>
      <div class="col-lg-3 quantity">Quantity: 2</div>
      <div class="col-lg-3 total-price">IDR500000</div>
    </div>

    <div class="row product-item">
      <div class="col-lg-6 product-details">
        <img src="product2.jpg" alt="Product Image" class="product-image">
        <div class="product-name">Wooden Coaster Set</div>
        <div class="product-price">IDR150000</div>
      </div>
      <div class="col-lg-3 quantity">Quantity: 1</div>
      <div class="col-lg-3 total-price">IDR150000</div>
    </div>
  ...
  <!-- Footer Start -->
  <div class="container-fluid footerk border-top">
    <footer class="py-3">
      <div class="row row-cols-1 row-cols-md-2 py-2">
        ...
        <div class="col-md-9 mb-3">
          <p class="slogan">
            We collaborate with ambitious brands and people; <br> let’s build something great together.
          </p>
        </div>
      </div>
